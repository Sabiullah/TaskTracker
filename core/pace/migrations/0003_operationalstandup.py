        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("Breakdown", "Breakdown"), ("Breakthrough", "Breakthrough")],
                        default="",
                        max_length=20,
                    ),
                ),
                ...
                (
                    "org",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="operational_standups", to="users.org"
                    ),
                ),
                (
                    "profile",
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("org", "profile", "standup_date"), name="uniq_op_standup_org_profile_date"
                    )
                ],
            },
        ),
